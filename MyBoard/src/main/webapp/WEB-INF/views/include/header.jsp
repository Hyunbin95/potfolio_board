...
<link href="/resources/bootstrap/css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
<!-- IE 9 이하의 버전에서 접속했을 때 HTML5의 semantic 태그를 인식하도록 하는 설정
조금 후 부터는 이설정을 안해도 됩니다. -->
<!--[if lt IE 9]>
	...
	<div class="wrapper">
		<header class="main-header">
			<div class="page-header">
				<h1 align="center"><a href="/"><img src="/userimage/google.png" height="150px"/></a></h1>
			</div>
		</header>
	</div>
	<aside class="main-sidebar">
		<section class="sidebar">
			<ul class="nav nav-tabs">
				...
				<c:if test="${user == null}">
					<li role="presentation"><a href="/user/login">게시물 쓰기 </a></li>
				...
				<c:if test="${user != null}">
					...
					</span> <span>${user.nickname}</span></li>
				</c:if>
			</ul>
		</section>
	</aside>
